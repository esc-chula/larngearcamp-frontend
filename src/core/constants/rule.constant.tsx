...
export const ruleConstant = [
  {
    ...
    contents: [
      `ใบตอบรับผู้ปกครองค่ายลานเกียร์ ครั้งที่ 22 <span><a href='/assets/file/ใบตอบรับผู้ปกครอง.pdf' ${defaultLinkProps}>ดาวน์โหลด</a></span>`
    ]
  },
  {
    ...
    contents: [
      ...
      "ใบตอบรับผู้ปกครองค่ายลานเกียร์ ครั้งที่ 22 (.pdf / .jpg / .png)",
      `ใบปพ.1 (หนังสือรับรองผลการเรียน) ปพ.6 (ใบเกรด) หรือ ปพ.7 (ใบรับรองสถานภาพการศึกษา) ที่ตรงตามเงื่อนไขตามที่ทางค่ายกำหนด (อ่านเพิ่มเติมได้ที่ <span><a href='/faq' ${defaultLinkProps}>แถบคำถามที่พบบ่อย</a></span>) (.pdf / .jpg / .png)`
    ]
  },
  {
