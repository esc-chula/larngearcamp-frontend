...
const qualificationsConstant: Array<QualificationModel> = [
  ...
  {
    description:
      "จะต้องได้รับวัคซีนที่ทางราชการกำหนดอย่างน้อยสองเข็ม หรือวัคซีนชนิดอื่นที่สำนักงานคณะกรรมการอาหารและยารับรองตามจำนวนที่กำหนด แล้วแต่กรณี ก่อนวันที่ 22 ธันวาคม 2565 (14 วัน ก่อนวันค่ายวันแรก)",
