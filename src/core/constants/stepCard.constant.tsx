  ...
  5: {
    incomplete: {
      true: {
        ...
        contents:
          "อย่าลืมชำระค่าสนับสนุนกิจกรรมเป็นจำนวน ึ700 บาท ก่อนวันที่ 25 พฤศจิกายน 2565 และกรอกฟอร์มยืนยันการฉีดวัคซีนก่อนวันที่ 11 มกราคม 2566 เพื่อยืนยันสิทธิ์การเข้าร่วมค่ายด้วยล่ะ !!"
      }
    },
    inProgress: {
      true: {
        ...
        contents: (
          <>
            ...
            <div style={{ marginTop: "0.75rem" }}>
              อย่าลืมชำระเงิน<span style={{ fontWeight: 500, color: "#941014" }}>ก่อนวันที่ 25 พฤศจิกายน</span> และกรอกฟอร์มยืนยันการฉีดวัคซีน
              <span style={{ fontWeight: 500, color: "#941014" }}>ก่อนวันที่ 25 พฤศจิกายน</span> เพื่อยืนยันสิทธิ์การเข้าร่วมค่ายด้วยล่ะ !!
            </div>
          </>
        ),
        primaryButton: {
