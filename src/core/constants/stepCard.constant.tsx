  ...
  3: {
    ...
    complete: {
      true: {
        ...
        contents:
          "ขอแสดงความยินดี !! น้องเป็นหนึ่งในผู้มีสิทธิ์สัมภาษณ์ เตรียมตัวได้พบปะพูดคุยกับพี่ ๆ ผู้สัมภาษณ์สุดน่ารักและใจดีในวันที่ 29 ตุลาคม 2565 ณ คณะวิศวกรรมศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย สำหรับน้อง ๆ กรุงเทพฯ และปริมณฑล หรือ สัมภาษณ์ผ่านทางซูมสำหรับน้อง ๆ ต่างจังหวัด ได้เลย !!"
      },
      false: {
        title: (
          <>
  ...
  4: {
    ...
    complete: {
      true: {
        ...
        contents: (
          <>
            ขอแสดงความยินดี !! น้องเป็นหนึ่งในผู้มีสิทธิ์เข้าร่วมค่ายลานเกียร์ ครั้งที่ 22 แต่ใด ๆ ก็ตาม อย่าลืมชำระค่าสนับสนุนกิจกรรมเป็นจำนวน 500 บาท ภายในวันที่ 4 ธันวาคม 2565 เพื่อยืนยันสิทธิ์การเข้าร่วมค่ายด้วยหล่ะ !!
            <div style={{ marginTop: "0.75rem" }}>
  ...
  5: {
    incomplete: {
      true: {
        ...
        contents:
          "อย่าลืมชำระค่าสนับสนุนกิจกรรมเป็นจำนวน 500 บาท ก่อนวันที่ 4 ธันวาคม 2565 และกรอกฟอร์มยืนยันการฉีดวัคซีนก่อนวันที่ 11 มกราคม 2566 เพื่อยืนยันสิทธิ์การเข้าร่วมค่ายด้วยล่ะ !!"
      }
    },
    inProgress: {
      true: {
        ...
        contents: (
          <>
            ...
            <div style={{ marginTop: "0.75rem" }}>
              อย่าลืมชำระเงิน<span style={{ fontWeight: 500, color: "#941014" }}>ก่อนวันที่ 4 ธันวาคม 2565</span> และกรอกฟอร์มยืนยันการฉีดวัคซีน
              <span style={{ fontWeight: 500, color: "#941014" }}>ก่อนวันที่ 4 ธันวาคม 2565</span> เพื่อยืนยันสิทธิ์การเข้าร่วมค่ายด้วยล่ะ !!
            </div>
          </>
        ),
        primaryButton: {
  ...
  6: {
    incomplete: {
      true: {
        ...
        contents: "วันค่ายจะจัดขึ้นในวันที่ 26 - 29 มกราคม 2566 นี้ ที่คณะวิศวกรรมศาสตร์ จุฬาลงกรณ์มหาวิทยาลัยนั่นเอง"
      }
    },
    inProgress: {
      true: {
        ...
        contents: (
          <>
            ขอแสดงความยินดีด้วย !! น้องเป็นหนึ่งในผู้ที่มีสิทธิ์เข้าร่วมค่ายลานเกียร์ครั้งที่ 22 อย่างเป็นทางการแล้ว โดยวันค่ายจะจัดขึ้นในวันที่ 26 - 29 มกราคม 2566 นี้ ที่คณะวิศวกรรมศาสตร์ จุฬาลงกรณ์มหาวิทยาลัยนั่นเอง 
            <div style={{ marginTop: "0.75rem" }}>
